...
<body>
    <div class="type-31">
		<!-- module 8888888888888888888888888888888888 -->	
		<div class="module-8">
			<div class="back-2">
				<div class="container">
		            <div class="wrapper">
		                <div class="row">
                            <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_custom_1456147489225 vc_row-no-padding">
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper-2">
                                            <div class="norma sc_section margin_top_null margin_bottom_null aligncenter" data-animation="animated fadeInUp">
                                                ...
                                                <div id="owl-demo" class="margin_top_medium margin_bottom_medium">
