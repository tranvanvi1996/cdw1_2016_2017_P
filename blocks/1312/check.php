<?php
$root_url = 'http://localhost/contact/';
...
if (!empty($id)) {
    $url = $root_url . 'contact.php';

    $url_less = $root_url . 'less/type.less';
    $url_bootsrap = $root_url .  'bootstrap/css/bootstrap.css';
    $url_awesome = $root_url .  'font-awesome/css/font-awesome.min.css';
